...
Button_add=tk.Button(root,padx=39,pady=20,text="+",command=button_add)
Button_clear=tk.Button(root,padx=81,pady=20,text="clear",command=button_clear)
Button_equal=tk.Button(root,padx=91,pady=20,text="=",command=button_equal)

Button_sub=tk.Button(root,padx=39,pady=20,text="-",command=button_sub)
Button_mul=tk.Button(root,padx=39,pady=20,text="*",command=button_mul)
Button_div=tk.Button(root,padx=39,pady=20,text="/",command=button_div)
